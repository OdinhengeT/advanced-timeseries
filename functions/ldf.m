%% Non-Linear Timeseries Analysis Project 2023 - Implementation of LDF
% Aron Paulsson and Torbjörn Onshage
function [rho] = ldf(y, maxLag, lambda, order, signLvl, boolPlot, boolZeroLag)
    ...
    rho = xldf(y, y, maxLag, lambda, order, signLvl, boolPlot, boolZeroLag);
end
